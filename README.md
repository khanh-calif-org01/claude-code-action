...
1. Install the Claude GitHub app to your repository: https://github.com/apps/claude-code
...
The [Claude Code GitHub app](https://github.com/apps/claude-code) requires these permissions:
